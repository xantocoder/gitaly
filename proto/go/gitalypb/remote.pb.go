...
type FetchRemoteWithStatusResponse_Status int32

const (
	FetchRemoteWithStatusResponse_FAST_FORWARD_UPDATE FetchRemoteWithStatusResponse_Status = 0
	FetchRemoteWithStatusResponse_FORCED_UPDATE       FetchRemoteWithStatusResponse_Status = 1
	FetchRemoteWithStatusResponse_PRUNED              FetchRemoteWithStatusResponse_Status = 2
	FetchRemoteWithStatusResponse_TAG_UPDATE          FetchRemoteWithStatusResponse_Status = 3
	FetchRemoteWithStatusResponse_FETCHED             FetchRemoteWithStatusResponse_Status = 4
	FetchRemoteWithStatusResponse_UPDATE_FAILED       FetchRemoteWithStatusResponse_Status = 5
	FetchRemoteWithStatusResponse_UNCHANGED           FetchRemoteWithStatusResponse_Status = 6
)

var FetchRemoteWithStatusResponse_Status_name = map[int32]string{
...
var FetchRemoteWithStatusResponse_Status_value = map[string]int32{
...
func (x FetchRemoteWithStatusResponse_Status) String() string {
	return proto.EnumName(FetchRemoteWithStatusResponse_Status_name, int32(x))
}

func (FetchRemoteWithStatusResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eefc82927d57d89b, []int{15, 0}
}
...
type FetchRemoteWithStatusRequest struct {
	Repository           *Repository `protobuf:"bytes,1,opt,name=repository,proto3" json:"repository,omitempty"`
	Remote               string      `protobuf:"bytes,2,opt,name=remote,proto3" json:"remote,omitempty"`
...
func (m *FetchRemoteWithStatusRequest) Reset()         { *m = FetchRemoteWithStatusRequest{} }
func (m *FetchRemoteWithStatusRequest) String() string { return proto.CompactTextString(m) }
func (*FetchRemoteWithStatusRequest) ProtoMessage()    {}
func (*FetchRemoteWithStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_eefc82927d57d89b, []int{14}
}

func (m *FetchRemoteWithStatusRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FetchRemoteWithStatusRequest.Unmarshal(m, b)
}
func (m *FetchRemoteWithStatusRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FetchRemoteWithStatusRequest.Marshal(b, m, deterministic)
}
func (m *FetchRemoteWithStatusRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FetchRemoteWithStatusRequest.Merge(m, src)
}
func (m *FetchRemoteWithStatusRequest) XXX_Size() int {
	return xxx_messageInfo_FetchRemoteWithStatusRequest.Size(m)
}
func (m *FetchRemoteWithStatusRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_FetchRemoteWithStatusRequest.DiscardUnknown(m)
}

var xxx_messageInfo_FetchRemoteWithStatusRequest proto.InternalMessageInfo

func (m *FetchRemoteWithStatusRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *FetchRemoteWithStatusRequest) GetRemote() string {
	if m != nil {
		return m.Remote
	}
	return ""
...
func (m *FetchRemoteWithStatusRequest) GetForce() bool {
	if m != nil {
		return m.Force
	}
	return false
...
func (m *FetchRemoteWithStatusRequest) GetNoTags() bool {
	if m != nil {
		return m.NoTags
	}
	return false
...
func (m *FetchRemoteWithStatusRequest) GetTimeout() int32 {
	if m != nil {
		return m.Timeout
	}
	return 0
...
func (m *FetchRemoteWithStatusRequest) GetSshKey() string {
	if m != nil {
		return m.SshKey
	}
	return ""
...
func (m *FetchRemoteWithStatusRequest) GetKnownHosts() string {
	if m != nil {
		return m.KnownHosts
	}
	return ""
...
func (m *FetchRemoteWithStatusRequest) GetNoPrune() bool {
	if m != nil {
		return m.NoPrune
	}
	return false
...
func (m *FetchRemoteWithStatusRequest) GetRemoteParams() *Remote {
	if m != nil {
...
type FetchRemoteWithStatusResponse struct {
	RefUpdates           []*FetchRemoteWithStatusResponse_RefUpdate `protobuf:"bytes,1,rep,name=ref_updates,json=refUpdates,proto3" json:"ref_updates,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                   `json:"-"`
	XXX_unrecognized     []byte                                     `json:"-"`
	XXX_sizecache        int32                                      `json:"-"`
}
...
func (m *FetchRemoteWithStatusResponse) GetRefUpdates() []*FetchRemoteWithStatusResponse_RefUpdate {
	if m != nil {
		return m.RefUpdates
	}
	return nil
...
type FetchRemoteWithStatusResponse_RefUpdate struct {
	Status               FetchRemoteWithStatusResponse_Status `protobuf:"varint,1,opt,name=status,proto3,enum=gitaly.FetchRemoteWithStatusResponse_Status" json:"status,omitempty"`
...
func (m *FetchRemoteWithStatusResponse_RefUpdate) Reset() {
	*m = FetchRemoteWithStatusResponse_RefUpdate{}
}
func (m *FetchRemoteWithStatusResponse_RefUpdate) String() string { return proto.CompactTextString(m) }
func (*FetchRemoteWithStatusResponse_RefUpdate) ProtoMessage()    {}
func (*FetchRemoteWithStatusResponse_RefUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_eefc82927d57d89b, []int{15, 0}
}

func (m *FetchRemoteWithStatusResponse_RefUpdate) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FetchRemoteWithStatusResponse_RefUpdate.Unmarshal(m, b)
}
func (m *FetchRemoteWithStatusResponse_RefUpdate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FetchRemoteWithStatusResponse_RefUpdate.Marshal(b, m, deterministic)
}
func (m *FetchRemoteWithStatusResponse_RefUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FetchRemoteWithStatusResponse_RefUpdate.Merge(m, src)
}
func (m *FetchRemoteWithStatusResponse_RefUpdate) XXX_Size() int {
	return xxx_messageInfo_FetchRemoteWithStatusResponse_RefUpdate.Size(m)
}
func (m *FetchRemoteWithStatusResponse_RefUpdate) XXX_DiscardUnknown() {
	xxx_messageInfo_FetchRemoteWithStatusResponse_RefUpdate.DiscardUnknown(m)
}

var xxx_messageInfo_FetchRemoteWithStatusResponse_RefUpdate proto.InternalMessageInfo

func (m *FetchRemoteWithStatusResponse_RefUpdate) GetStatus() FetchRemoteWithStatusResponse_Status {
	if m != nil {
		return m.Status
	}
...
func (m *FetchRemoteWithStatusResponse_RefUpdate) GetRef() string {
	if m != nil {
		return m.Ref
	}
	return ""
...
func init() {
	proto.RegisterEnum("gitaly.FetchRemoteWithStatusResponse_Status", FetchRemoteWithStatusResponse_Status_name, FetchRemoteWithStatusResponse_Status_value)
	...
	proto.RegisterType((*FetchRemoteWithStatusRequest)(nil), "gitaly.FetchRemoteWithStatusRequest")
	proto.RegisterType((*FetchRemoteWithStatusResponse)(nil), "gitaly.FetchRemoteWithStatusResponse")
	proto.RegisterType((*FetchRemoteWithStatusResponse_RefUpdate)(nil), "gitaly.FetchRemoteWithStatusResponse.RefUpdate")
}
...
var fileDescriptor_eefc82927d57d89b = []byte{
	...
	,
}
...
type RemoteServiceClient interface {
	...
	FetchRemoteWithStatus(ctx context.Context, in *FetchRemoteWithStatusRequest, opts ...grpc.CallOption) (RemoteService_FetchRemoteWithStatusClient, error)
}
...
func (c *remoteServiceClient) FetchRemoteWithStatus(ctx context.Context, in *FetchRemoteWithStatusRequest, opts ...grpc.CallOption) (RemoteService_FetchRemoteWithStatusClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RemoteService_serviceDesc.Streams[2], "/gitaly.RemoteService/FetchRemoteWithStatus", opts...)
	if err != nil {
		return nil, err
	}
	x := &remoteServiceFetchRemoteWithStatusClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type RemoteService_FetchRemoteWithStatusClient interface {
	Recv() (*FetchRemoteWithStatusResponse, error)
	grpc.ClientStream
}

type remoteServiceFetchRemoteWithStatusClient struct {
	grpc.ClientStream
}

func (x *remoteServiceFetchRemoteWithStatusClient) Recv() (*FetchRemoteWithStatusResponse, error) {
...
type RemoteServiceServer interface {
	...
	FetchRemoteWithStatus(*FetchRemoteWithStatusRequest, RemoteService_FetchRemoteWithStatusServer) error
}
...
func (*UnimplementedRemoteServiceServer) FetchRemoteWithStatus(req *FetchRemoteWithStatusRequest, srv RemoteService_FetchRemoteWithStatusServer) error {
...
func _RemoteService_FetchRemoteWithStatus_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(FetchRemoteWithStatusRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(RemoteServiceServer).FetchRemoteWithStatus(m, &remoteServiceFetchRemoteWithStatusServer{stream})
}

type RemoteService_FetchRemoteWithStatusServer interface {
	Send(*FetchRemoteWithStatusResponse) error
	grpc.ServerStream
}

type remoteServiceFetchRemoteWithStatusServer struct {
	grpc.ServerStream
}

func (x *remoteServiceFetchRemoteWithStatusServer) Send(m *FetchRemoteWithStatusResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _RemoteService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _RemoteService_FetchRemoteWithStatus_Handler,
			ServerStreams: true,
		},
	},
