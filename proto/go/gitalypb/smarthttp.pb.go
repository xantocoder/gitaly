...
type ParsedInfoRefsRequest struct {
	Repository *Repository `protobuf:"bytes,1,opt,name=repository,proto3" json:"repository,omitempty"`
	// Parameters to use with git -c (key=value pairs)
	GitConfigOptions []string `protobuf:"bytes,2,rep,name=git_config_options,json=gitConfigOptions,proto3" json:"git_config_options,omitempty"`
	// Git protocol version
...
func (m *ParsedInfoRefsRequest) Reset()         { *m = ParsedInfoRefsRequest{} }
func (m *ParsedInfoRefsRequest) String() string { return proto.CompactTextString(m) }
func (*ParsedInfoRefsRequest) ProtoMessage()    {}
func (*ParsedInfoRefsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7da929f3b109874f, []int{2}
}

func (m *ParsedInfoRefsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ParsedInfoRefsRequest.Unmarshal(m, b)
}
func (m *ParsedInfoRefsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ParsedInfoRefsRequest.Marshal(b, m, deterministic)
}
func (m *ParsedInfoRefsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParsedInfoRefsRequest.Merge(m, src)
}
func (m *ParsedInfoRefsRequest) XXX_Size() int {
	return xxx_messageInfo_ParsedInfoRefsRequest.Size(m)
}
func (m *ParsedInfoRefsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ParsedInfoRefsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ParsedInfoRefsRequest proto.InternalMessageInfo

func (m *ParsedInfoRefsRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *ParsedInfoRefsRequest) GetGitConfigOptions() []string {
	if m != nil {
		return m.GitConfigOptions
	}
	return nil
...
func (m *ParsedInfoRefsRequest) GetGitProtocol() string {
	if m != nil {
		return m.GitProtocol
	}
	return ""
...
type ParsedInfoRefsResponse struct {
	// capabilities is only sent in the first response message.
...
func (m *ParsedInfoRefsResponse) Reset()         { *m = ParsedInfoRefsResponse{} }
func (m *ParsedInfoRefsResponse) String() string { return proto.CompactTextString(m) }
func (*ParsedInfoRefsResponse) ProtoMessage()    {}
func (*ParsedInfoRefsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7da929f3b109874f, []int{3}
}

func (m *ParsedInfoRefsResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ParsedInfoRefsResponse.Unmarshal(m, b)
}
func (m *ParsedInfoRefsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ParsedInfoRefsResponse.Marshal(b, m, deterministic)
}
func (m *ParsedInfoRefsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParsedInfoRefsResponse.Merge(m, src)
}
func (m *ParsedInfoRefsResponse) XXX_Size() int {
	return xxx_messageInfo_ParsedInfoRefsResponse.Size(m)
}
func (m *ParsedInfoRefsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ParsedInfoRefsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ParsedInfoRefsResponse proto.InternalMessageInfo

func (m *ParsedInfoRefsResponse) GetCapabilities() []string {
	if m != nil {
...
func (m *ParsedInfoRefsResponse) GetRefs() []*Ref {
	if m != nil {
		return m.Refs
	}
	return nil
...
func (*PostUploadPackResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7da929f3b109874f, []int{6}
}
...
func (*PostReceivePackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7da929f3b109874f, []int{7}
}
...
func (*PostReceivePackResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7da929f3b109874f, []int{8}
}
...
func init() {
	...
	proto.RegisterType((*ParsedInfoRefsRequest)(nil), "gitaly.ParsedInfoRefsRequest")
	proto.RegisterType((*ParsedInfoRefsResponse)(nil), "gitaly.ParsedInfoRefsResponse")
...
var fileDescriptor_7da929f3b109874f = []byte{
	...
	,
}
...
type SmartHTTPServiceClient interface {
	...
	ParsedInfoRefsUploadPack(ctx context.Context, in *ParsedInfoRefsRequest, opts ...grpc.CallOption) (SmartHTTPService_ParsedInfoRefsUploadPackClient, error)
...
func (c *smartHTTPServiceClient) ParsedInfoRefsUploadPack(ctx context.Context, in *ParsedInfoRefsRequest, opts ...grpc.CallOption) (SmartHTTPService_ParsedInfoRefsUploadPackClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SmartHTTPService_serviceDesc.Streams[1], "/gitaly.SmartHTTPService/ParsedInfoRefsUploadPack", opts...)
	if err != nil {
		return nil, err
	}
	x := &smartHTTPServiceParsedInfoRefsUploadPackClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type SmartHTTPService_ParsedInfoRefsUploadPackClient interface {
	Recv() (*ParsedInfoRefsResponse, error)
	grpc.ClientStream
}

type smartHTTPServiceParsedInfoRefsUploadPackClient struct {
	grpc.ClientStream
}

func (x *smartHTTPServiceParsedInfoRefsUploadPackClient) Recv() (*ParsedInfoRefsResponse, error) {
	m := new(ParsedInfoRefsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *smartHTTPServiceClient) InfoRefsReceivePack(ctx context.Context, in *InfoRefsRequest, opts ...grpc.CallOption) (SmartHTTPService_InfoRefsReceivePackClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SmartHTTPService_serviceDesc.Streams[2], "/gitaly.SmartHTTPService/InfoRefsReceivePack", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *smartHTTPServiceClient) PostUploadPack(ctx context.Context, opts ...grpc.CallOption) (SmartHTTPService_PostUploadPackClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SmartHTTPService_serviceDesc.Streams[3], "/gitaly.SmartHTTPService/PostUploadPack", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *smartHTTPServiceClient) PostReceivePack(ctx context.Context, opts ...grpc.CallOption) (SmartHTTPService_PostReceivePackClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SmartHTTPService_serviceDesc.Streams[4], "/gitaly.SmartHTTPService/PostReceivePack", opts...)
	if err != nil {
		return nil, err
	}
...
type SmartHTTPServiceServer interface {
	...
	// Just the like InfoRefsUploadPack but returns a parsed response.
	ParsedInfoRefsUploadPack(*ParsedInfoRefsRequest, SmartHTTPService_ParsedInfoRefsUploadPackServer) error
	// The response body for GET /info/refs?service=git-receive-pack
	// Will be invoked when the user executes a `git push`, but only advertises
	// references to the user.
...
func (*UnimplementedSmartHTTPServiceServer) ParsedInfoRefsUploadPack(req *ParsedInfoRefsRequest, srv SmartHTTPService_ParsedInfoRefsUploadPackServer) error {
	return status.Errorf(codes.Unimplemented, "method ParsedInfoRefsUploadPack not implemented")
}
...
func _SmartHTTPService_ParsedInfoRefsUploadPack_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ParsedInfoRefsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SmartHTTPServiceServer).ParsedInfoRefsUploadPack(m, &smartHTTPServiceParsedInfoRefsUploadPackServer{stream})
}

type SmartHTTPService_ParsedInfoRefsUploadPackServer interface {
	Send(*ParsedInfoRefsResponse) error
	grpc.ServerStream
}

type smartHTTPServiceParsedInfoRefsUploadPackServer struct {
	grpc.ServerStream
}

func (x *smartHTTPServiceParsedInfoRefsUploadPackServer) Send(m *ParsedInfoRefsResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _SmartHTTPService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ParsedInfoRefsUploadPack",
			Handler:       _SmartHTTPService_ParsedInfoRefsUploadPack_Handler,
			ServerStreams: true,
		},
		{
